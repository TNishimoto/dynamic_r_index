...
int main(int argc, char *argv[])
{
    ...
    std::vector<uint64_t> isa = stool::construct_ISA(text_vec, sa, stool::Message::NO_MESSAGE);
    std::vector<uint8_t> bwt = stool::construct_BWT(text_vec, sa, stool::Message::NO_MESSAGE);
